...
export type TupoksiData = Record<TupoksiPosition, TupoksiItem>;

export const tupoksiData: TupoksiData = {
  'kepala-sekolah': {
    ...
    content: `
      ...
      <div class="space-y-4">
        ...
        <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
          ...
          <li>Melaporkan kegiatan laboratorium kepada <span class="tupoksi-link" onclick="showTupoksi('kepala-sekolah')">Kepala Sekolah</span></li>
          <li>Memastikan kesiapan alat dan bahan untuk praktikum</li>
          <li>Mengevaluasi kebutuhan perbaikan alat dan melaporkan ke <span class="tupoksi-link" onclick="showTupoksi('wakil-kepala')">Wakil Kepala Sekolah</span> bidang sarana prasarana</li>
